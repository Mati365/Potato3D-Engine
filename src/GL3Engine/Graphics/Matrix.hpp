    ...
    namespace CoreMatrix {
        ...
        template<typename T> class Matrix {
            public:
                ...
                Matrix(GLuint, GLuint, const std::initializer_list<T>&);
    ...
    template<typename T> inline Matrix<T> operator oper(const Matrix<T>& l, \
        ...
        template<typename T, GLuint COLS, GLuint ROWS> class t_Matrix :
            ...
            public:
                ...
                t_Matrix(const std::initializer_list<T>& array)
                        :
...
#define VEC_GETTER(name, index) \
        ...
        class MatMatrix {
            public:
                ...
                static Mat4 orthof(const std::array<Vec2, 3>&);
                ...
                static inline void mul(std::vector<Vec4*> v, const Mat4& m) {
                    for (auto& _v : v)
                        *_v = m * (*_v);
                }
